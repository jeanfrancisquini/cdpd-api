...
router.get(
  "/api/PlanningFuncionalEvaluation",
  PlanningFuncionalEvaluationController.get,
);
router.post(
  "/api/PlanningFuncionalEvaluation",
  PlanningFuncionalEvaluationController.post,
);
router.put(
  "/api/PlanningFuncionalEvaluation",
  PlanningFuncionalEvaluationController.put,
);
router.delete(
  "/api/PlanningFuncionalEvaluation",
  PlanningFuncionalEvaluationController.delete,
);
//#endregion
...
router.get(
  "/api/PlanningMacrocycleMonth",
  PlanningMacrocycleMonthController.get,
);
router.post(
  "/api/PlanningMacrocycleMonth",
  PlanningMacrocycleMonthController.post,
);
router.put(
  "/api/PlanningMacrocycleMonth",
  PlanningMacrocycleMonthController.put,
);
router.delete(
  "/api/PlanningMacrocycleMonth",
  PlanningMacrocycleMonthController.delete,
);
//#endregion

//#region planejamento_macrociclo_mes_dados
router.get(
  "/api/PlanningMacrocycleMonthDatas",
  PlanningMacrocycleMonthDatasController.get,
);
router.post(
  "/api/PlanningMacrocycleMonthDatas",
  PlanningMacrocycleMonthDatasController.post,
);
router.put(
  "/api/PlanningMacrocycleMonthDatas",
  PlanningMacrocycleMonthDatasController.put,
);
router.delete(
  "/api/PlanningMacrocycleMonthDatas",
  PlanningMacrocycleMonthDatasController.delete,
);
//#endregion
...
router.get(
  ...
  PlanningMacrocycleMonthDatasCharacteristicsController.get,
);
router.post(
  "/api/PlanningMacrocycleMonthDatasCharacteristics",
  PlanningMacrocycleMonthDatasCharacteristicsController.post,
);
router.put(
  "/api/PlanningMacrocycleMonthDatasCharacteristics",
  PlanningMacrocycleMonthDatasCharacteristicsController.put,
);
router.delete(
  "/api/PlanningMacrocycleMonthDatasCharacteristics",
...
router.get(
  "/api/PlanningPathologicalHistory",
  PlanningPathologicalHistoryController.get,
);
router.post(
  "/api/PlanningPathologicalHistory",
  PlanningPathologicalHistoryController.post,
);
router.put(
  "/api/PlanningPathologicalHistory",
  PlanningPathologicalHistoryController.put,
);
router.delete(
  "/api/PlanningPathologicalHistory",
  PlanningPathologicalHistoryController.delete,
);
//#endregion

//#region planejamento_macrociclo_mes_dados_caracateristicas
router.get(
  "/api/PlanningPosturalEvaluation",
  PlanningPosturalEvaluationController.get,
);
router.post(
  "/api/PlanningPosturalEvaluation",
  PlanningPosturalEvaluationController.post,
);
router.put(
  "/api/PlanningPosturalEvaluation",
  PlanningPosturalEvaluationController.put,
);
router.delete(
  "/api/PlanningPosturalEvaluation",
  PlanningPosturalEvaluationController.delete,
);
//#endregion
...
router.delete(
  "/api/PlanningDailyControl",
  PlanningDailyControlController.delete,
);
router.get(
  "/api/PlanningDailyControl/GetById",
  PlanningDailyControlController.getById,
);
//#endregion

//#region planejamento
router.delete(
  "/api/Planning/DeletePlanning",
...
router.get("/api/Planning/GetById", PlanningController.getById);
...
router.post(
  "/api/Report/GetReportSchedule",
  ReportController.getReportSchedule,
);
router.post(
  "/api/Report/GetReportNextPlanning",
  ReportController.getReportNextPlanning,
);
//#endregion
...
router.post(
  "/api/Schedule/ScheduleBulkAdd",
  ScheduleController.scheduleBulkAdd,
);
