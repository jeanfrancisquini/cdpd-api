...
class PlanningMacrocycleMonthDatasCharacteristicsController {
  post(request, response) {
    ...
    database
      ...
      .then((data) => {
        ...
        response.json({
          message:
            "Planejamento Macrociclo Mês Dados Caracteristicas criado com sucesso!",
        });
      })
      .catch((error) => {
        console.log(error);
  ...
  put(request, response) {
    ...
    database
      ...
      .then((data) => {
        ...
        response.json({
          message:
            "Planejamento Macrociclo Mês Dados Caracteristicas atualizado com sucesso!",
        });
      })
      .catch((error) => {
        console.log(error);
  ...
  delete(request, response) {
    ...
    database
      ...
      .then((data) => {
        ...
        response.json({
          message:
            "Planejamento Macrociclo Mês Dados Caracteristicas deletado com sucesso!",
        });
      })
      .catch((error) => {
        console.log(error);
  ...
  patchObs(request, response) {
    ...
    database
      ...
      .then((data) => {
        console.log(data);
        response.json({ message: "Observação atualizada com sucesso!" });
      })
      .catch((error) => {
        console.log(error);
      });
